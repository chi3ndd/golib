...
func (con *service) CreateIndex(database, collection string, index *bson.M, unique bool) error {
	opts := options.Index()
...
func (con *service) Get(database, collection, id string, result interface{}) error {
...
func (con *service) Count(database, collection string, query *bson.M) (int64, error) {
...
func (con *service) FindOne(database, collection string, query *bson.M, sorts []string, offset int64, result interface{}) error {
...
func (con *service) FindMany(database, collection string, query *bson.M, sorts []string, size, offset int64, results interface{}) (int64, error) {
	opts := options.Find()
...
func (con *service) InsertOne(database, collection string, doc Document) error {
...
func (con *service) InsertMany(database, collection string, docs []Document, ordered bool) error {
...
func (con *service) UpdateByID(database, collection string, id interface{}, update interface{}) error {
...
func (con *service) UpdateOne(database, collection string, query *bson.M, update interface{}, upsert bool) error {
	opts := options.Update()
...
func (con *service) UpdateMany(database, collection string, query *bson.M, update interface{}, upsert bool) error {
	opts := options.Update()
	opts.SetUpsert(upsert)
	opts.SetBypassDocumentValidation(true)
...
func (con *service) DeleteByID(database, collection string, id interface{}) error {
...
func (con *service) DeleteOne(database, collection string, query *bson.M) error {
...
func (con *service) DeleteMany(database, collection string, query *bson.M) error {
...
func (con *service) Aggregate(database, collection string, pipeline []*bson.M, results interface{}) error {
