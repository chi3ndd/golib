...
func (r *service) newConnection() error {
	var err error
...
func (r *service) newChannel() error {
...
func (r *service) DeclareExchange(name, kind string, durable bool) error {
	// Success
	return r.channel.ExchangeDeclare(name, kind, durable, false, false, false, nil)
}

func (r *service) DeclareQueue(name string, durable bool, priority int, ttl clock.Duration) error {
	table := amqp.Table{}
	if priority > 0 {
...
func (r *service) BindQueue(queue, exchange string) error {
	// Success
	return r.channel.QueueBind(queue, queue, exchange, false, nil)
}

func (r *service) Qos(prefetchCount int) error {
...
func (r *service) Publish(exchange, queue string, message Message) error {
...
func (r *service) Consume(queue string, auto bool, prefetchCount int, callback Consumer) error {
	if prefetchCount == 0 {
		prefetchCount = 1
	}
