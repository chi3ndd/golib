...
func (w *Worker) Log(level Level, calldepth int, info *Info) error {
...
func New(module string, level Level, color bool, out io.Writer) (Logger, error) {
	if module == "" {
		module = "DEFAULT"
	} else {
...
func (l *logger) logInternal(lvl Level, message string, pos int) {
